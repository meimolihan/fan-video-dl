...
本项目仅供学习和个人使用。使用者需自行承担因使用本工具而产生的一切法律责任。

- 本工具会将下载的视频存储在部署服务器的 `downloads/` 目录中，供在线播放和文件管理
- **部署者有责任自行管理服务器上的下载内容**，及时清理不需要的文件，不应将服务器作为长期存储或公开分发受版权保护内容的场所
- 下载的视频版权归原作者所有，请勿用于商业用途或二次传播
- 使用者应遵守所在地区的法律法规以及目标网站的使用条款
